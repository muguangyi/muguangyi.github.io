...
获取多个Service的异步任务。返回的Result是一个IService[]，其中的Service 顺序和传入的Service的Id在string[]中的顺序一致。


## Inheritance Hierarchy
<a href="http://msdn2.microsoft.com/zh-cn/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="2f732106-c1d3-cfc7-e9bd-96254f667f0a">GameBox.Framework.C0</a><br />&nbsp;&nbsp;&nbsp;&nbsp;<a href="6b13ee22-910d-81b0-00d6-f25003f7b115">GameBox.Framework.AsyncTask</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;GameBox.Framework.ServicesTask<br />
...
The ServicesTask type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="db398cf5-61bd-e2d5-74a8-145fdd177972">ServicesTask</a></td><td>
构造函数</td></tr></table>&nbsp;
<a href="#servicestask-class">Back to Top</a>
