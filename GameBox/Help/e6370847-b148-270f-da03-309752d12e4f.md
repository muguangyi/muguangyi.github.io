...
**C#**<br />
``` C#
public interface ILuaStruct : IService
```

The ILuaStruct type exposes the following members.
...
<a href="#iluastruct-interface">Back to Top</a>
...
#### Reference
<a href="e1ac12c0-1f02-84b6-8aeb-aef6062de0aa">GameBox.Service.LuaRuntime.Struct Namespace</a><br />