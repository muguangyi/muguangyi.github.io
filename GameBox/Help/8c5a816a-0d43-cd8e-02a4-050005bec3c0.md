...
根据Service类型获取单个Service


## Inheritance Hierarchy
<a href="http://msdn2.microsoft.com/zh-cn/library/e5kfa45b" target="_blank">System.Object</a><br />&nbsp;&nbsp;<a href="2f732106-c1d3-cfc7-e9bd-96254f667f0a">GameBox.Framework.C0</a><br />&nbsp;&nbsp;&nbsp;&nbsp;<a href="6b13ee22-910d-81b0-00d6-f25003f7b115">GameBox.Framework.AsyncTask</a><br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;GameBox.Framework.ServiceTask(T)<br />
...
**C#**<br />
``` C#
public class ServiceTask<T> : AsyncTask
where T : IService
...
#### Type Parameters
&nbsp;<dl><dt>T</dt><dd /></dl>&nbsp;
The ServiceTask(T) type exposes the following members.


## Constructors
&nbsp;<table><tr><th></th><th>Name</th><th>Description</th></tr><tr><td>![Public method](media/pubmethod.gif "Public method")</td><td><a href="413c8f06-1bd7-e2bd-2506-31445292df1e">ServiceTask(T)</a></td><td>
构造函数。</td></tr></table>&nbsp;
<a href="#servicetask(*t*)-class">Back to Top</a>
...
Gets the type of the current instance.
 (Inherited from <a href="http://msdn2.microsoft.com/zh-cn/library/e5kfa45b" target="_blank">Object</a>.)</td></tr><tr><td>![Protected method](media/protmethod.gif "Protected method")</td><td><a href="cee461e9-eb51-7c53-b5e2-3f5ebe8231b5">IsDone</a></td><td>
是否完成。
