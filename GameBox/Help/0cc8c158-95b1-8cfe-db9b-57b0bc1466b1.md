...
\[Missing <summary> documentation for "T:GameBox.Service.UIToLua.IUIToLua"\]
...
**C#**<br />
``` C#
public interface IUIToLua : IService
```

The IUIToLua type exposes the following members.
...
<a href="#iuitolua-interface">Back to Top</a>
...
#### Reference
<a href="dc643547-87c0-a0ce-d69d-30eaca3c82f8">GameBox.Service.UIToLua Namespace</a><br />